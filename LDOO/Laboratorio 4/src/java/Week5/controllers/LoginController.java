...
public class LoginController extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    String txtEma = request.getParameter("ema");
    String txtOcu = request.getParameter("ocu");
    ...
    boolean isValidUser =  Authentication.authenticate(txtUsername, txtPassword, txtEma, txtOcu, txtNombre, txtApellidos);

    if(isValidUser) {

        //Construye instancia del modelo User
        User user = new User(txtUsername, txtPassword, txtEma, txtOcu, txtNombre, txtApellidos);
